...
class ExerciseImages extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  ExerciseImages(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<int> categoryId = GeneratedColumn<int>(
      'category_id', aliasedName, false,
      type: DriftSqlType.int,
      requiredDuringInsert: false,
  ...
  @override
  ExerciseImages createAlias(String alias) {
    return ExerciseImages(attachedDatabase, alias);
  }
...
class DatabaseAtV17 extends GeneratedDatabase {
  ...
  late final ExerciseImages exerciseImages = ExerciseImages(this);
